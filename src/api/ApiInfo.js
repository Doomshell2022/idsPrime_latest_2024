...
// export const BASE_URL = 'https://staging.idsprime.com/api/IIMobilelatest/';
...
export const GET_COURSE_TRACKER = BASE_URL + 'searchCoursetracker';
export const DELETE_COURSE_TRACKER = BASE_URL + 'deleteCoursetracker';
