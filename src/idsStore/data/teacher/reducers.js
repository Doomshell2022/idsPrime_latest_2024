...
const addCourseTrackerRReducer = (state = {}, action) => {
  switch (action.type) {
    case types.ADD_COURSE_TRACKER:
      return action.payload;
...
const getfetchCourseTrackerReducer = (state = {}, action) => {
  switch (action.type) {
    case types.FETCH_COURSE_TRACKER:
      return action.payload;
...
const deleteCourseTrackerReducer = (state = {}, action) => {
  switch (action.type) {
    case types.DELETE_COURSE_TRACKER:
      return action.payload;
...
const reducer = combineReducers({
  ...
  addCourseTracker: addCourseTrackerRReducer,
  fetchCourseTracker: getfetchCourseTrackerReducer,
  deleteCourseTracker: deleteCourseTrackerReducer,
});
