...
// courseTracker
export const isGetCourseTtracker = state => {
  return state.teacher.addCourseTracker;
};
export const isFetchCourseTracker = state => {
  return state.teacher.fetchCourseTracker;
};
export const isDeleteCourseTracker = state => {
  return state.teacher.deleteCourseTracker;
};
