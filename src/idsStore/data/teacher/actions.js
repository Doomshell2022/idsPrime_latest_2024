...
export const addCourseTracker = payload => ({
  type: types.ADD_COURSE_TRACKER,
  payload,
});

export const fetchCourseTracker = payload => ({
  type: types.FETCH_COURSE_TRACKER,
  payload,
});
export const deleteCoursetracker = payload => ({
  type: types.DELETE_COURSE_TRACKER,
  payload,
});
