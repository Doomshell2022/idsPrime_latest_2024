...
// import {GET_DATE_WISE_STUDENT_ASSIGNMENT} from './types';
// STUDENT_INFO
...
// ASSIGNMENT
export const getStudentAssignment = selectedDate => async dispatch => {
  console.log('====================================');
  console.log('kh', selectedDate);
  console.log('====================================');
  try {
    // fetching active school from local storage
    const activeSchool = await getActiveSchool();
...
// bhjene
export const getDateWiseStudentAssignment = date => async dispatch => {
  try {
    // fetching active school from local storage
    const activeSchool = await getActiveSchool();
    if (!activeSchool) {
    ...
    // calling api
    const response = await makeRequest(DATE_WISE_STUDENT_ASSIGNMENT, params);
    console.log('====================================');
    console.log('gewt response DATE_WISE_STUDENT_ASSIGNMENT', response);
    console.log('====================================');
    // Alert.alert('', FETCH_STUDENT_ASSIGNMENTS);
    return dispatch(actions.getDateWiseStudentAssignment(response));
  } catch (error) {}
};
// RESULT
