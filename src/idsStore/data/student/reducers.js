...
const getDateWiseStudentAssignmentReducer = (state = {}, action) => {
  switch (action.type) {
    case types.GET_DATE_WISE_STUDENT_ASSIGNMENT:
      return action.payload;
...
const reducer = combineReducers({
  ...
  getDateWiseStudentAssignment: getDateWiseStudentAssignmentReducer,
