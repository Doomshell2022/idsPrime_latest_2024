...
class AdminCalendarScreen extends Component {
  ...
  renderEventTypeSection = () => {
    ...
    return (
      <>
        <View style={styles.calendarInfoSection}>{twoItemGroupList}</View>
      </>
    );
  };
  ...
  renderEventDescriptionPopup = () => {
    ...
    const leftSubContainerTexts = [month, day, year].map(value => (
      <Text key={value} style={styles.leftSubContainerText}>
        {value}
      </Text>
    ));
    ...
    return (
      <View
        ...
        <View style={styles.popupContentContainer}>
          <View style={leftSubContainerStyles}>{leftSubContainerTexts}</View>
          <View style={styles.rightSubContainer}>
            ...
            {/* <Text style={styles.rightSubContainerText1}>{title}</Text> */}
            {/* </View> */}
