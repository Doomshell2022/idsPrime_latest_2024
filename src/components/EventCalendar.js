  ...
  return (
    <Calendar
      ...
      theme={{
        ...
        textDayFontSize: wp(3.2), // Adjust the font size for day numbers
        textMonthFontSize: wp(3.2), // Adjust the font size for month names
        textDayHeaderFontSize: wp(3.2), // Adjust the font size for day headers (M, T, W, ...)
      }}
